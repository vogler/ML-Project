...
\section{Overview}
% trim=l b r t
\centerline{\includegraphics[width=\columnwidth, trim=25 10 25 10]{overview}}

blabla

\section{Generation of Training Data}
\subsection{Image Generation}
\color{red} example of some generated images \color{black}
\subsection{Image Processing}

\section{Training}
\subsection{Neural Network}
\subsection{Support Vector Machine}
\subsection{Logistic Regrssion}
